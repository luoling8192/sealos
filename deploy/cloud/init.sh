...
retryPullImage docker.io/luoling8192/fst-desktop-frontend:latest
...
sealos save -o tars/frontend-desktop.tar  docker.io/luoling8192/fst-desktop-frontend:latest
